...
If the user wants to set up an allowlist, edit `~/.config/matclaw/sender-allowlist.json` on the host:
...
- The config file is on the host at `~/.config/matclaw/sender-allowlist.json`, not inside the container
